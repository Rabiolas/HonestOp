...
def summarize_opinions(question_id: str):
    ...
    user_prompt = f"""You are an AI assistant tasked with providing a concise and honest summary of a set of anonymous opinions. Also provide a general sentiment (positive, negative, mixed) towards the topic asked (this should come first). 
